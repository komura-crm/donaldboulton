...
![Hebrew Text](../assets/hebrew-text.webp "hebrew text")
_[`hebrew.text` Hebrew of Enoch](../assets/hebrew-text.webp)_

![Enoch Circle](../assets/enoch-w.webp "Enoch Circle")
_[`enoch.circle` Structural Enoch Circle](../assets/enoch-w.webp)_

![Giza Description](../assets/chrono-trans.webp "Structural Bible")
_[`structural.bible` Giza Description](../assets/chrono-trans.webp)_
