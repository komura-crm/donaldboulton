...
github_editme_path: donaldboulton/bibwoe.com/blob/master/content/posts/creation-of-all.mdx
---

import GitHubButtons from '../../src/components/GithubButtonsRepo'
import Share from '../../src/components/Share'

![Creation](../assets/creation-header.webp)
...
![A Trinity Subset in All Colors](../assets/trinity-page.webp "trinity subset in all colors")
_[`trinity subset in all colors`](https://bibwoe.com)_

![A Trinity in All Substance](../assets/trinity-math.webp "trinity in all substance")
